...
// При клике на кнопки передавать значение счетчика в календарь.
// и вызывать функцию, которая будет перерисовываь только цифры в таблице и название месяца, будет получать номер месяца
// передавать значение isPrevious, isCurrent при клике на кнопки
